...
contract DeferredEquityPlan {
    ...
    uint public unlock_time = fakenow + 365; // Your code here!
    ...
    constructor(address payable _employee) public {
        ...
        require(unlock_time <= fakenow, "Error, time gone by!");
        require(distributed_shares <= total_shares, "Error, something is wrong"); // Your code here!
        ...
        distributed_shares = ((fakenow - start_time) / 365 days * annual_distribution); // Your code here!
